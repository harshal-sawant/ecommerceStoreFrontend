...
export class ShopService {
  ...
  getProduct(productId: string) {
    // let Headers = this.getHeaders()
    return this.http
      .get<Product>(`${this.url}products/${productId}`)
      .pipe(catchError(this.errorHandler));
  }
  ...
  searchProducts(query: string) {
    let Headers = this.getHeaders();
    return this.http
      .get<Product[]>(`${this.url}products/?category=${query}`, {
        headers: Headers,
      })
      .pipe(catchError(this.errorHandler));
  }
  ...
  removeItemFromCart(productId: string) {
    ...
    return this.http
      .post<Product>(
        `${this.url}carts/remove-cart-item`,
        { productId: productId },
        { headers: httpHeaders }
      )
      .pipe(catchError(this.errorHandler));
  ...
  emptyCart() {
    let Headers = this.getHeaders();
    return this.http
      .put<Cart>(`${this.url}carts/empty-cart`, null, { headers: Headers })
      .pipe(catchError(this.errorHandler));
  }
  ...
  getCart() {
    let Headers = this.getHeaders();
    return this.http
      .get<Cart>(`${this.url}carts/get-cart`, { headers: Headers })
      .pipe(catchError(this.errorHandler));
  }
  ...
  getCartCount() {
    let Headers = this.getHeaders();
    return this.http
      .get<any>(`${this.url}carts/get-cart`, { headers: Headers })
      .pipe(catchError(this.errorHandler))
      .subscribe((res) => {
        if (res) {
  ...
  createOrder(orderData: Order) {
    let Headers = this.getHeaders();
    return this.http
      .post<Order>(`${this.url}orders`, orderData, { headers: Headers })
      .pipe(catchError(this.errorHandler));
  }
  ...
  getUserOrders() {
    let Headers = this.getHeaders();
    return this.http
      .get<Order[]>(`${this.url}orders/user-orders`, { headers: Headers })
      .pipe(catchError(this.errorHandler));
  }
  ...
  deleteOrder(orderId: any) {
    let Headers = this.getHeaders();
    return this.http
      .delete<any>(`${this.url}orders/${orderId}`, { headers: Headers })
      .pipe(catchError(this.errorHandler));
  }
}
